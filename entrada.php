...
<body>
    ...
    <div class="p-4 sm:ml-64">
        ...
        <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
            ...
            <li class="w-full">
                <a href="entrada.php" class="inline-block w-full p-4 text-gray-900 bg-gray-100 rounded-l-lg focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white" aria-current="page">INGRESOS</a>
            </li>
            <li class="w-full">
        ...
        <div class="cuerpo">
            <div class="titulo">
                <h1 class="titulo"> ABASTECIMIENTO DE PRODUCTOS </h1>
            </div>
            <div class="separador">
                <hr class="linea_g">
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if($query -> rowCount() > 0) { 
                                                    ...
                                                    <td class='px-6 py-4'>".$result -> id_entrada."</td>
                                                    <td class='px-6 py-4'>".$result -> codigo."</td>
                                                    <td class='px-6 py-4'>".$result -> cantidad."</td>
                                                    <td class='px-6 py-4'>".$result -> fecha_ingreso."</td>
                                                    </tr> </div>";
                                                    }
                                                }
                                            ?>
